...
print(f"sum of loans:{sum_of_loans}")
# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan_amount = sum_of_loans / total_loans
print(f"average amount:{average_loan_amount}")
...
# YOUR CODE HERE!
if loan["loan_price"] >= fair_value:
    print(f"the loan is worth at least the cost to buy it")
else:
    print(f"loan is too expensive and not worth the price")
...
present_value = get_present_value(
    new_loan["future_value"], new_loan["remaining_months"], annual_discount_rate
)
